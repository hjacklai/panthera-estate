...
const I18N = {
  en: {
    ...
    "hero.h1.a": "Nineteen homes.",
    "hero.h1.b": "A shared green.",
    "hero.lede": "A quiet, private enclave of nineteen freehold homes set around a shared central park of over 700 m². Floor-to-ceiling glass and full-width sliding doors draw the green into every living room. Built around how a family really lives, on a quiet stretch of the mainland that is only now beginning to move.",
    ...
    "site.note3.h": "Room to breathe",
    "site.note3.t": "49 m² to 201 m² of green margin per lot.",
    "site.note3.b": "Far more side and rear setback than a typical taman launch gives you. Enough room to plant a frangipani, run a hedge, set a porch garden, not the maintenance strip you can't walk in.",
    "site.note4.h": "Drainage & infrastructure",
    "site.note4.t": "Engineered with a 298 m² retention pond.",
    "site.note4.b": "On-site Kolam Tadahan handles stormwater. Concrete drains run all four sides. Built for the long monsoon.",

    "homes.eyebrow": "The Homes",
    "homes.title": "Two house types.",
    ...
    "arch.feature.cap": "Bungalow Type · Front facade",
  ...
  bm: {
    ...
    "hero.h1.a": "Sembilan belas rumah.",
    "hero.h1.b": "Satu taman dikongsi.",
    "hero.lede": "Enklaf persendirian yang tenang, sembilan belas rumah pegangan bebas mengelilingi taman pusat dikongsi seluas lebih 700 m². Tingkap lantai ke siling dan pintu gelongsor sepenuh dinding membawa kehijauan masuk ke setiap ruang tamu. Dibina mengikut cara sesebuah keluarga sebenar tinggal, di tepi tenang tanah besar yang kini baru mula rancak.",
    ...
    "site.note3.h": "Ruang untuk bernafas",
    "site.note3.t": "49 m² hingga 201 m² sempadan hijau setiap lot.",
    "site.note3.b": "Jauh lebih lapang daripada taman biasa. Cukup ruang untuk menanam frangipani, membuat pagar hidup, atau menggubah halaman porch, bukan jalur sempit yang tidak boleh dilalui.",
    "site.note4.h": "Saliran & infrastruktur",
    "site.note4.t": "Direka dengan kolam tadahan 298 m².",
    "site.note4.b": "Kolam Tadahan di tapak mengendalikan air hujan. Longkang konkrit empat sisi. Dibina untuk musim monsun yang panjang.",

    "homes.eyebrow": "Rumah",
    "homes.title": "Dua jenis rumah.",
    ...
    "arch.feature.cap": "Jenis Banglo · Fasad hadapan",
  ...
  zh: {
    ...
    "hero.h1.a": "十九栋家。",
    "hero.h1.b": "一片共享绿地。",
    "hero.lede": "宁静私密的住宅区, 十九栋永久地契住宅, 环绕逾 700 平方米的中央绿地而建。落地玻璃窗与整面推拉门, 让翠绿庭园直入每一间客厅。依家庭真实的生活方式而设计, 落脚于对岸宁静的一隅, 正值这片土地开始蓬勃发展之时。",
    ...
    "site.note3.h": "留白的空间",
    "site.note3.t": "每块地皆有 49 至 201 m² 绿色边界。",
    "site.note3.b": "比一般住宅区的退缩宽得多。足以种鸡蛋花、种树篱、布置前廊花园, 不是那种走不进去、只能维护的窄边。",
    "site.note4.h": "排水与基础设施",
    "site.note4.t": "设计含 298 m² 蓄水池。",
    "site.note4.b": "现场 Kolam Tadahan 处理雨水,四周混凝土排水沟。为漫长的雨季而建。",
