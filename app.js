...
const I18N = {
  en: {
    ...
    "h.bungalow.pitch": "Built for three generations under one roof: 2,598 sq ft on the estate's largest lots, with a flexible ground-floor suite for grandparents, guests or a home office. Five bedrooms, six baths.",
  ...
  bm: {
    ...
    "h.bungalow.pitch": "Direka untuk tiga generasi di bawah satu bumbung: 2,598 kaki persegi di atas lot terbesar dalam pembangunan, dengan suite tingkat bawah yang fleksibel untuk ibu bapa, tetamu atau pejabat rumah. Lima bilik tidur, enam bilik air.",
  ...
  zh: {
    ...
    "h.bungalow.name": "独立式",
    "h.bungalow.pitch": "为三代同堂而建:2,598 平方英尺,坐落全区最大地段,底层设有灵活套房,可作长辈房、客房或居家办公室。五房六浴。",
