...
const I18N = {
  en: {
    ...
    "reg.lede": "Register and we'll WhatsApp you the full price list, floor plans and brochure, plus first pick of lots before public launch. No deposit, no obligation.",
    ...
    "reg.contact.fin.h": "Mortgage-ready",
    "reg.contact.fin.b": "Panel banks on board. Pre-qualify in 3 to 5 working days.",
  ...
  bm: {
    ...
    "reg.lede": "Daftar dan kami akan WhatsApp anda senarai harga penuh, pelan lantai dan brosur, serta pilihan lot terdahulu sebelum pelancaran umum. Tiada deposit, tiada obligasi.",
    ...
    "reg.contact.fin.h": "Sedia pembiayaan",
    "reg.contact.fin.b": "Bank panel sudah disediakan. Prakelayakan dalam 3 hingga 5 hari bekerja.",
  ...
  zh: {
    ...
    "reg.eyebrow": "登记您的意向",
    "reg.title": "抢占先机。",
    "reg.lede": "登记后,我们会通过 WhatsApp 发送完整价目表、平面图与宣传册,并让您在公开发布前优先选购地段。无需订金,绝无义务。",
    "trust.1": "仅 19 户",
    "trust.2": "永久地契",
    ...
    "reg.contact.fin.h": "贷款无忧",
    "reg.contact.fin.b": "合作银行已就位。3 至 5 个工作日内完成预审。",
