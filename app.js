...
const I18N = {
  en: {
    ...
    "faq.a5": "Full structure and finishes, sanitaryware, water heaters, electrical points, fibre & CAT-6. Kitchen cabinets, air-con and light fixtures are your fit-out.",
    ...
    "faq.a9": "Yes. Panel lenders are Maybank, CIMB, RHB and Hong Leong. Pre-qualification takes 3–5 working days; terms depend on your profile.",
    "faq.a10": "Register anyway. You'll get launch pricing first and first refusal on the lots you flag. No obligation, no deposit now.",
    ...
    "bertam.lede": "For thirty years Bertam was the quiet side of the bridge. Now RM 13 billion of industry is landing five minutes away. It won't stay quiet for long.",
    ...
    "bertam.s1u": "Lithium battery plant · 5 min from site · operational 2027",
    "bertam.s2u": "Semiconductor & precision manufacturing · jobs already on the ground",
    "bertam.s3u": "Adjacent township by SP Setia · driving regional demand",
    ...
    "cat3.tag": "Pre-launch",
    "cat4.l": "Anchor",
    "cat4.h": "INV plant operational. Tech Park tenants move in.",
    "cat4.b": "A five-minute commute. Rental demand from engineers and professionals follows.",
    "cat5.l": "Handover",
  ...
  bm: {
    ...
    "faq.a5": "Struktur dan kemasan penuh, kelengkapan sanitari, pemanas air, titik elektrik, fiber & CAT-6. Kabinet dapur, penyaman udara dan lampu ialah kerja anda.",
    ...
    "faq.a9": "Ya. Bank panel ialah Maybank, CIMB, RHB dan Hong Leong. Pra-kelayakan mengambil 3–5 hari bekerja; terma bergantung pada profil anda.",
    "faq.a10": "Daftar juga. Anda akan dapat harga pelancaran dahulu dan hak pertama menolak pada lot yang anda tandakan. Tiada obligasi, tiada deposit sekarang.",
    ...
    "bertam.lede": "Selama tiga puluh tahun Bertam ialah sisi tenang jambatan. Kini RM 13 bilion industri mendarat lima minit dari sini. Ia takkan kekal tenang lama.",
    ...
    "bertam.s1u": "Kilang bateri litium · 5 min dari tapak · beroperasi 2027",
    "bertam.s2u": "Pembuatan separa konduktor & jitu · pekerjaan sudah ada",
    "bertam.s3u": "Bandar bersebelahan oleh SP Setia · memacu permintaan serantau",
    ...
    "cat4.l": "Penambat",
    "cat4.h": "Kilang INV beroperasi. Penyewa Tech Park masuk.",
    "cat4.b": "Perjalanan lima minit. Permintaan sewa daripada jurutera dan profesional menyusul.",
    "cat5.l": "Penyerahan",
  ...
  zh: {
    ...
    "faq.a5": "完整结构与饰面、卫浴、热水器、电源点、光纤与 CAT-6。橱柜、冷气与灯具由您自行装置。",
    ...
    "faq.a9": "可以。合作银行有 Maybank、CIMB、RHB 与 Hong Leong。预先评估需 3–5 个工作日;条款视您的情况而定。",
    "faq.a10": "也请登记。您将优先获得开盘价格,并对所标记的单位享有优先选择权。现在无义务、无订金。",
    ...
    "bertam.lede": "三十年来,北赖是大桥宁静的一侧。如今 RM 130 亿的产业正落户五分钟外。这份宁静不会太久。",
    "bertam.thesis": "您买下的是一座市镇里的<span class=\"accent\">土地</span>,<br>而国家此刻<br>选择倾力发展它。",
    "bertam.s1u": "锂电池厂 · 距项目 5 分钟 · 2027 投产",
    "bertam.s2u": "半导体与精密制造 · 就业已就位",
    "bertam.s3u": "SP Setia 毗邻新镇 · 带动区域需求",
    "bertam.s4k": "五年资本增长",
    ...
    "cat3.tag": "预发布",
    "cat4.l": "落定",
    "cat4.h": "INV 工厂投产。科技园租户进驻。",
    "cat4.b": "五分钟通勤。工程师与专业人士的租赁需求随之而来。",
    "cat5.l": "交屋",
    "cat5.h": "钥匙交付。",
